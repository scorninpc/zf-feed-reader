...
function filesmtime() {
	...
	$filesmtime = max(@filemtime(dirname(__FILE__) . "/../../vendor/smartoptimizer/minifiers/" . $fileType . ".php"), filemtime(dirname(__FILE__) . "/../../vendor/smartoptimizer/index.php"), filemtime(dirname(__FILE__) . "/../../vendor/smartoptimizer/config.php"));
...
$settings['minify'] = $settings['minify'] && file_exists(dirname(__FILE__) . "/../../vendor/smartoptimizer/minifiers/" . $fileType . ".php");
...
if (!$settings['clientCache'] || !$settings['clientCacheCheck'] || !isset($_SERVER['HTTP_IF_MODIFIED_SINCE']) || $_SERVER['HTTP_IF_MODIFIED_SINCE'] != $mtimestr) {
	...
	if ($generateContent) {
		if ($settings['minify']) include(dirname(__FILE__) . "/../../vendor/smartoptimizer/minifiers/" . $fileType . ".php");
